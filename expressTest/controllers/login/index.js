...
module.exports = function (req, res, next) {
    ...
    axios.get(`https://api.weixin.qq.com/sns/jscode2session?appid=${appid}&secret=${appConfig[appid].secret}&js_code=${code}&grant_type=authorization_code`)
        .then(response => {
